import { fromEvent, race, last, map, share, startWith, switchMap, take, takeUntil, tap, filter,Observable, BehaviorSubject, NEVER } from 'rxjs';
...
export interface DraggableObservables {
