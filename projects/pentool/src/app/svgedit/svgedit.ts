...
export class SVGEdit {
    ...
    public set svg(value: SVGElement | undefined) {
        ...
        if (this._svg) {
            ...
            if (!this.svg?.querySelector('.editorControls')) {
                ...
                this.nearestPoint = new Point(this.svg, 'nearest-point', () => this.draw(), this.positionUpdated.bind(this), this.onPointClick.bind(this));
    ...
    initKeyboard() {
        fromEvent(window, 'keydown').subscribe((event: any) => {
            ...
            console.log('this.altDown', this.keyAltDown);
            if (this.keyAltDown) {
    ...
    initMouseGuestures() {
        ...
        mouseMove$.subscribe((event) => {
            ...
            if (this.nearestPoint && n && smallestDistance < 10) {
                ...
                this.setHighlightedSegment(n, segment);
            } else {
    ...
    setHighlightedSegment(n: any, segment: any) {
