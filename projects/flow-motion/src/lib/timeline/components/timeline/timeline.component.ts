...
import { FMContainer, KeyManager, FMService, SelectionManager } from '../../../../public-api';

@Component({
  selector: 'timeline',
  imports: [TimelineRulerComponent, TimelineKeyframeComponent, TimelineTweenComponent, FMContainer, CommonModule, TimelineControlsComponent, ContextMenu],
