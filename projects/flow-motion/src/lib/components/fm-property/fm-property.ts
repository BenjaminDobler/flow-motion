import { Directive, ElementRef, inject, input, model, Signal, signal, forwardRef, effect } from '@angular/core';
  ...
  hostDirectives: [
    {
      ...
      inputs: ['draggable', 'fm-container', 'positioning', 'fm-container:fm-property'],
    },
  ],
  host: {
...
export class FMProperty {
  ...
  ngBondService = inject(FMService);
